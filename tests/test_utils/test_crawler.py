...
def mock_requests_get(url, **kwargs):
    responses = {
        ...
        "https://example.com/page1": MagicMock(
            status_code=200,
            text='<html><body><a href="/">Home</a><a href="/page2">Page 2</a></body></html>',
        ),
        "https://example.com/page2": MagicMock(
            status_code=200, text="<html><body><p>No links here.</p></body></html>"
        ),
    }
...
def test_explore_website_avoids_cycles(mock_get):
    ...
    responses = {
        ...
        "https://example.com/page1": MagicMock(
            status_code=200, text='<html><body><a href="/">Home</a></body></html>'
        ),
    }
    mock_get.side_effect = lambda url, **kwargs: responses.get(
